...
public class ServerIdentity extends Builder {
    ...
    public static final Command<Boolean> GEN_NEXT = new Command<>("gen-next",
            ...
            a -> {
                ...
                idstore.setRecord(current, generateSignedIpnsRecord(currentPrivate, Optional.of(Multihash.decode(nextPeerId.getBytes())), false));
    ...
    public static byte[] generateSignedIpnsRecord(PrivKey peerPrivate, Optional<Multihash> host, boolean moved) {
        int years = 1;
    ...
    public static final Command<Boolean> ROTATE = new Command<>("rotate",
            ...
            a -> {
                ...
                PrivKey currentPrivate = KeyKt.unmarshalPrivateKey(idstore.getPrivateKey(current));
                idstore.setRecord(current, generateSignedIpnsRecord(currentPrivate, Optional.of(Multihash.decode(nextPeerId.getBytes())), true));
                idstore.addIdentity(nextPriv, generateSignedIpnsRecord(nextPriv, Optional.empty(), false));
