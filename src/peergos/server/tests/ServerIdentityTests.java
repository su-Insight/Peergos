...
public class ServerIdentityTests {
    ...
    public void rotation() {
        ...
        byte[] signedRecord = ServerIdentity.generateSignedIpnsRecord(currentPrivate, Optional.empty(), false);
        ...
        idstore.setRecord(current, ServerIdentity.generateSignedIpnsRecord(currentPrivate, Optional.of(Multihash.decode(nextPeerId.getBytes())), true));
        idstore.addIdentity(nextPriv, ServerIdentity.generateSignedIpnsRecord(nextPriv, Optional.empty(), false));
