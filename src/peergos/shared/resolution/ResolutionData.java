 ...
 */
public class ResolutionData implements Cborable {
    ...
    public ResolutionData(Optional<Multihash> host,
                          boolean moved,
    ...
    public static ResolutionData fromCbor(Cborable cbor) {
        ...
        return new ResolutionData(host, moved, mutablePointer, seq);
    }
}
